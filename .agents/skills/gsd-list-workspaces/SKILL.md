...
<execution_context>
@.agents/get-shit-done/workflows/list-workspaces.md
@.agents/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the list-workspaces workflow from @.agents/get-shit-done/workflows/list-workspaces.md end-to-end.
</process>
